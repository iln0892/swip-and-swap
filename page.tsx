      ...
      <div className="flex">
        <div className="flex-1 pr-96">
          ...
          <section className="pb-24 px-6">
            ...
            <p className="text-xl leading-relaxed max-w-5xl mb-4">
            ...
            <p className="text-xl leading-relaxed max-w-5xl">
              ...
              ging es nicht nur um das Tauschen von Kleidung, sondern um eine neue Form des Austauschs: Musik, kuratiert
              von einem DJ, und Getränke begleiteten das Event, um den Prozess des Gebens und Nehmens als offene,
              soziale Interaktion zu gestalten. Der Fokus lag nicht auf Verzicht oder bloßer Nachhaltigkeit, sondern auf
              der aktiven Auseinandersetzung mit Besitz, Wert und Zirkulation – jenseits festgefahrener Konsumlogiken.
            </p>
          </section>
        ...
        {/* Playlist */}
        <div className="w-96 fixed right-0 top-0 h-screen p-6 pt-20 bg-[#E5E5E3] overflow-y-auto">
